...
export default function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative flex min-h-[100svh] flex-col justify-between px-5 pb-8 pt-28 md:px-10 md:pb-10 md:pt-36"
      aria-label="Introduction"
    >
      <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-10 md:min-h-[62vh] md:justify-between">
